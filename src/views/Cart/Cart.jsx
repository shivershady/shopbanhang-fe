        ...
        <div className="md:flex shadow-md my-10 rounded-xl overflow-hidden">
          <div className="md:w-3/4 bg-white px-10 py-10">
            ...
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              ...
              <span className="text-center w-1/5  text-sm text-red-500">
                $400.00
              </span>
              <span className="text-center w-1/5  text-sm text-red-500">
                $400.00
            ...
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow w-1/2">
                  <span className="font-bold text-sm">Xiaomi Mi 20000 mAh</span>
          ...
          <div id="summary" className="md:w-1/4 px-8 py-10">
            ...
            <div className="border-t mt-8">
              ...
              <button className="bg-indigo-600 py-4 px-8 text-white font-bold uppercase text-xs rounded hover:bg-gray-200 hover:text-gray-800 w-full">
                Xác nhận
              </button>
            </div>
          </div>
