          ...
          <form>
            ...
            <div>
              <div class="w-full flex flex-row gap-2 py-4">
                <button class=" w-full  border border-transparent rounded-md shadow-sm text-base  text-white bg-red-600 p-1 hover:bg-gray-200 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white ">
                  {" "}
                  Đăng Ký{" "}
                </button>
                <button class=" w-full border border-transparent rounded-md shadow-sm text-base  text-white bg-indigo-600 p-1 hover:bg-gray-200 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                  {" "}
                  Đăng Nhập{" "}
                </button>
              </div>
