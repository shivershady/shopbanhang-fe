  ...
  return (
    <Popover class="grid grid-cols-5  h-screen lg:text-base text-sm  ">
      ...
      <div class="col-span-4 lg:col-start-2  col-start-1 w-screen lg:w-full  ">
        ...
        <button className="bg-red-600 hover:bg-red-400 w-16 text-center text-white border border-transparent rounded-md shadow-sm  display-flex justify-center"
        onClick={doLogout}>
            Log out
          </button>
                    ...
                    <div className="ml-6  pb-6 px-5">
                      <div className="flex items-center justify-between">
                        <div className="mx-2 opacity-20  ">
                          <Popover.Button className=" absolute">
                            ...
                            <XIcon
                              className="h-10 w-10 -mt-8 ml-56 opacity-0 "
                              aria-hidden="true"
                            />
                          </Popover.Button>
                        </div>
                      ...
                      <div className="mt-6 -ml-6">
                        <nav className="grid gap-y-4 ">
                          <p class="ml-10 ">
                            Tên khách hàng{" "}
                            <a href="" class="text-indigo-500 ml-5  underline">
                              Thay đổi
                            </a>
                          </p>
                          <img
                            src="https://vnn-imgs-f.vgcloud.vn/2020/03/23/11/trend-avatar-1.jpg "
                            className="w-10 h-10 rounded-full ml-2 -mt-14"
                          />
          ...
          <ul class="flex flex-col  list-none leading-10 ml-44   ">
            <div class=" text-left lg:ml-12 -ml-9  ">
              ...
              <li class=" rounded-lg mb-5  ">
                {" "}
                <input
                  class=" lg:w-1/2 md:1/3  w-full h-10 border border-transparent rounded-md shadow-sm border-gray-100 bg-white pl-1 "
                  type="text"
              ...
              <li class="rounded-lg mb-5  ">
                *****@gmail.com
                <a class="text-indigo-600 underline ml-2" href="">
                  Thay đổi
                </a>
              </li>
              ...
              <li class=" rounded-lg mb-5 ">
                {" "}
                <input
                  class=" lg:w-1/2 w-full h-10 border border-transparent rounded-md shadow-sm border-gray-100  bg-white pl-1 "
                  type="text"
              ...
              <li class="rounded-lg mb-5  ">
                <input
                  class="lg:w-1/6 w-1/3 h-10 border border-transparent rounded-md shadow-sm border-gray-100  bg-white  text-center "
                  type="number"
                  placeholder="01"
                />
                <input
